...
export const mockForslagData: Forslag[] = [
  ...
  },
  {
    ...
    conclusion:
      'Jag föreslår att regeringen genomför en nationell digitalisering av patientjournaler. Detta skulle innebära att alla vårdgivare använder samma digitala system för att dela patientinformation säkert och effektivt. Systemet ska vara användarvänligt, följa strikta sekretessregler och ge patienter kontroll över sin egen hälsodata. Genom att digitalisera sjukvården kan vi förbättra patientsäkerheten, minska medicinfel och göra vården mer effektiv. Låt oss modernisera svensk sjukvård för framtiden!',
    originalPostId: 2,
