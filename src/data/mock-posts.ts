...
export const mockPostsData: Post[] = [
  ...
  },
  {
    ...
    content: "Jag bor i en mindre kommun och ser hur svårt det är att hålla liv i samhället. Skolor stängs, affärer försvinner och unga människor flyttar till städerna. Detta är tråkigt eftersom landsbygden har så mycket att erbjuda. Jag tycker att vi behöver investera mer i infrastruktur på landsbygden, särskilt bredband och kollektivtrafik. Det skulle också vara bra med fler möjligheter för distansarbete så att människor kan bo på landsbygden men arbeta för företag i städerna. Vad tycker ni andra som bor på landsbygden? Hur kan vi göra det mer attraktivt att bo utanför storstäderna?",
    summary: "En diskussion om utmaningarna för landsbygden och förslag på hur man kan göra det mer attraktivt att bo utanför storstäderna.",
