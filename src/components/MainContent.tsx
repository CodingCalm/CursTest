...
export default function MainContent(): React.JSX.Element {
  ...
  return (
    <main className="w-full max-w-2xl space-y-2 px-4" role="main" id="main-content">
        ...
        <div className="flex items-center space-x-3">
          {session ? (
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">Skapa inlägg</span>
            </Link>
          ) : (
            <Link
              href="/auth/signin"
            ...
            >
              ...
              <span className="text-sm font-medium text-gray-900">Logga in för att skapa inlägg</span>
            </Link>
          )}
