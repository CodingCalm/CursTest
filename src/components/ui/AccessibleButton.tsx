...
export class AccessibleButton extends React.Component<AccessibleButtonProps> {
  ...
  private getButtonClasses(): string {
    const baseClasses =
      'inline-flex items-center justify-center font-medium rounded-md transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-opacity-50 disabled:opacity-50 disabled:cursor-not-allowed';
    ...
    const variantClasses = {
      primary:
        'bg-gray-800 text-white hover:bg-gray-900 focus-visible:ring-gray-400',
      secondary:
