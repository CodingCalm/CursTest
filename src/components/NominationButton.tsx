...
export function NominationButton({ isNominated, onToggle }: NominationButtonProps): React.JSX.Element {
  return (
    <button 
      ...
      aria-label={isNominated ? "Ta bort nominering" : "Nominera detta inlägg som proposition"}
      onClick={onToggle}
    >
      <svg 
