...
export default function Sidebar(): React.JSX.Element {
  return (
    ...
    >
      <h2 className="text-base sm:text-lg font-semibold text-purple-800 mb-2 sm:mb-4">Sidebar</h2>
      <p className="text-sm sm:text-base text-purple-700">Detta är sidopanelen.</p>
